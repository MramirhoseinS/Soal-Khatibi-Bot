          ...
          <div>
            <Te ch={ch} id={1} n={n} setCh={setCh}>
              <Soal id={1} p="ب">
                <div id="soal1">
                  <span>
                    ۱- شبنم خونی (Auspitz sign) از علائم اختصاصی کدام بیماری پوستی میباشد؟
                  </span>
                  <span>پمفیگوس </span>
                  <span>پسوریازیس</span>
                  <span>دمل </span>
            ...
            <Te ch={ch} id={9} n={n} setCh={setCh}>
              <Soal id={9} p="ب">
                <div id="soal9">
                  <span>
                    ۹- کدام یک از موارد زیر جزو درمان&zwnj;های موضعی رایج در پسوریازیس است؟
                  </span>
            ...
            <Te ch={ch} id={16} n={n} setCh={setCh}>
              <Soal id={16} p="ب">
                <div id="soal16">
                  ...
                  <span>
                    کراتوز اکتینیک به رنگ قرمز متمایل به قهوه ای تا خاکستری گرد و نامنظم و خشک و
                    پوسته مانند می&zwnj;باشد.
                  </span>
                  <span>
            ...
            <Te ch={ch} id={23} n={n} setCh={setCh}>
              <Soal id={23} p="د">
                <div id="soal23">
                  ...
                  <span>خم های مزمن با حاشیه ی مرواریدی - عروق تلانژکتاتیک در سطح ضایعه </span>
                </div>
              </Soal>
            </Te>
            ...
            <Te ch={ch} id={37} n={n} setCh={setCh}>
              <Soal id={37} p="ج">
                <div id="soal37">
                  <span>
                    ۳۷- کدام&zwnj; یک از موارد زیر به&zwnj;تنهایی معیار بستری شدن بیمار دچار سوختگی
                    در بیمارستان محسوب می&zwnj;شود؟
                  </span>
            ...
            <Te ch={ch} id={40} n={n} setCh={setCh}>
              <Soal id={40} p="ج">
                <div id="soal40">
                  <span>
                    ۴۰- بیمار ۳۷ساله با در صد سوختگی ۶۵درصد و با وزن ۷۰ کیلو گرم به اورژانس منتقل
                    شده است در ۲۴ساعت اول طبق فرمول پارکلند چه مقدار مایع &zwnj; و چه نوع مایع نیاز
                    دارد؟
                  </span>
            ...
            <Te ch={ch} id={46} n={n} setCh={setCh}>
              <Soal id={46} p="ج">
                <div id="soal46">
                  <span>
                    ۴۶- در مراقبت&zwnj;های پرستاری پس از پیوند پوست کدام یک از اقدامات زیر بیشترین
                    نقش را در پیشگیری از جابجایی گرافت دارد؟
                  </span>
            ...
            <Te ch={ch} id={48} n={n} setCh={setCh}>
              <Soal id={48} p="ج">
                <div id="soal48">
                  <span>
                    ۴۸- در صورت مشاهده پوست پیوندی با رنگ بنفش و سرد بودن ناحیه پرستار باید کدام
                    اقدام را در اولویت قرار دهد؟
                  </span>
            ...
            <Te ch={ch} id={61} n={n} setCh={setCh}>
              <Soal id={61} p="ج">
                <div id="soal61">
                  <span>
                    ۶۱- رویش نابجای مژه، زخم و پارگی قرنیه از علائم کدام یک از بیماری های التهابی
                    چشم میباشد؟
                  </span>
            ...
            <Te ch={ch} id={65} n={n} setCh={setCh}>
              <Soal id={65} p="الف">
                <div id="soal65">
                  <span>
                    ۶۵- بیماری به علت مسدود شدن غدد چربی، برجستگی روی پلک&zwnj;اش مشاهده
                    می&zwnj;شود. این عارضه ناشی از چیست؟ و نتیجه کدام یک از بیماری های التهابی چشم
                    می&zwnj;باشد؟
                  </span>
            ...
            <Te ch={ch} id={72} n={n} setCh={setCh}>
              <Soal id={72} p="ج">
                <div id="soal72">
                  <span>
                    ۷۲- استفاده از چه نوع لنزی پس از جراحی کاتاراکت برای دید بهتر و جلوگیری از
                    مشکلات عدسی برداشته شده توصیه می&zwnj;شود؟
                  </span>
